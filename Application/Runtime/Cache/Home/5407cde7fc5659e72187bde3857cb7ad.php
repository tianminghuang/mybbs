	...
	<div id="ct" class="wp cl">
		...
		<div id="postlist" class="pl bm">
			<table cellspacing="0" cellpadding="0">
				<tr>
					<td class="pls ptm pbm">
						<div class="hm">
							<span class="xg1">查看:</span> <span class="xi1"><?=$post['view_cnt']?></span><span class="pipe">|</span><span class="xg1">回复:</span> <span class="xi1"><?=$post['rep_cnt']?></span>
						</div>
					</td>
			...
			<div id="f_pst" class="pl bm bmw">
				<form method="post" id="fastpostform" action="/index.php?m=home&c=reply&a=save&pid=<?=$post['pid']?>" > 
