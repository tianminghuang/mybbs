                    ...
                    <?php foreach($posts as $post): ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <?php  if ($post['is_jing']==0){ echo '/index.php?m=admin&c=tiezi&a=setjing&pid='.$post['pid']; } else { echo '/index.php?m=admin&c=tiezi&a=setnojing&pid='.$post['pid']; } ?>
                                ">
                                <?php  if ($post['is_jing']==0){ echo '加精'; } else { echo '取消加精'; } ?>
                                </a> |
                                <a class="link-update" href="
                                <?php  if ($post['is_top']==0){ echo '/index.php?m=admin&c=tiezi&a=settop&pid='.$post['pid']; } else { echo '/index.php?m=admin&c=tiezi&a=setnotop&pid='.$post['pid']; } ?>
                                ">
                                <?php  if ($post['is_top']==0){ echo '顶置'; } else { echo '取消顶置'; } ?>
                                </a> |
                                <a class="link-update" href="
                                <?php  if ($post['is_display']==1){ echo '/index.php?m=admin&c=tiezi&a=sethidden&pid='.$post['pid']; } else { echo '/index.php?m=admin&c=tiezi&a=setdisplay&pid='.$post['pid']; } ?>
                                ">
                                <?php  if ($post['is_display']==1){ echo '显示'; } else { echo '隐藏'; } ?>
                            	</a> |
