    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php?m=admin&c=user&a=update2&uid=<?=$user['uid']?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>原来密码：</th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="reupwd" size="50" value="" type="password">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="nupwd" size="50" value="" type="password">
                                </td>
                            </tr>
